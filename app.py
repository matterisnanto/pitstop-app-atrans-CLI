    ...
    if st.button("🔄 Generate Laporan Terbaru", type="primary"):
        with st.spinner("Sedang memproses dan menghitung sisa KM..."):
            ...
            if os.path.exists('LAPORAN_LENGKAP_PITSTOP.xlsx'):
                ...
                # PERBAIKAN MUTLAK: Paksa semua data jadi teks (string) agar Streamlit/PyArrow tidak error
                df_hasil = df_hasil.astype(str)
                ...
                # PERBAIKAN WARNING: Menggunakan parameter 'width' yang baru
            ...
            if terpilih:
                ...
                if st.button("💾 Simpan KM"):
                    if km_baru < batas_minimum:
                        ...
                        st.success(f"✅ KM terbaru untuk {nopol_pilihan} berhasil disimpan!")

# HALAMAN 3: SETING INTERVAL
